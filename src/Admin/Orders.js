...
import { baseURLAPI, dataBicycle, dataOrders } from "../store";
...
export function Orders() {
    ...
    const handleShipping = (idTransaction) => {
        ...
        formDataPost.append('is_condirm_pay', false);
                                                ...
                                                orders.map((item, index) => (
                                                    <>
                                                        ...
                                                        <div style={{ marginLeft: '23px' }}>
                                                            ...
                                                            <p style={{ marginTop: '-15px' }}>Tgl. Bayar: {item.at_updated} ({item.payment})</p>
